...
export default function JobFilterForm({
  ...
  return (
    <div>
      ...
      <div className="rounded-2xl shadow-sm mt-10 px-4 sm:px-6">
        <h1 className="text-[28px] sm:text-[36px] md:text-[45px] text-center font-kantumruy font-semibold">
          All Job Posts
        </h1>
          ...
          >
            ...
            <div className="relative col-span-2 sm:col-span-1">
              ...
              <Input
                ...
                className="w-full pl-14 py-[18px] rounded-[11px] bg-[#DFDFDF]"
                onChange={(e) =>
                  setFilters({ ...filters, search: e.target.value })
                }
              />
